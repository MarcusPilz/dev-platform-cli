...
public class EarBuilderCommand extends AbstractBuilderCommand {
     ...
     * @param traFile 	the traFile
     * @param projectDir 	the location of vcrepo.dat
     * @param archive 	the location of the archive
     * @param outputEarFile 	the generated ear file
     * @param pathToAliases 	the path to aliase files
     */
